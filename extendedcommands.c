...
{
    static char* headers[] = {  "Apply update from .zip",
                                "",
                                NULL 
    };
    for (;;)
...
void show_mount_usb_storage_menu()
{
    ...
    sprintf(command, "echo %s > /sys/devices/platform/s3c-usbgadget/gadget/lun1/file", SDCARD_DEVICE_PRIMARY);
    __system(command);
...
{
    static char* headers[] = {  "Advanced Settings Menu",
                                "",
                                NULL
    };
    ...
    for (;;)
    {
        ...
        switch (chosen_item)
        {
            case 0:
                ...
                break;
            case 1:
                ui_print("Mount Internal SDCard\n");
                __system("echo /dev/block/mmcblk0p1 > /sys/devices/platform/s3c-usbgadget/gadget/lun2/file");
                ui_print("Done.\n");
                break;
            case 2:
                ui_print("Unmount Internal SDCard\n");
                __system("echo 0 > /sys/devices/platform/s3c-usbgadget/gadget/lun2/file");
                ui_print("Done.\n");
                break;
            case 3:
            {
                if (confirm_selection( "Confirm Flash?", "Yes - Flash zImage kernel/recovery")) {
                ui_print("Flashing zImage...\n");
                __system("flash_kernel");
                }
                ui_print("New zImage Flashed.\n");
                break;
            }
            case 4:
            {
